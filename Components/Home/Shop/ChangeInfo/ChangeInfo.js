...
export default class ChangeInfo extends Component {
    constructor(props) {
        ...
        this.state = { 
            txtName: 'To Vu Ca', 
            txtAddress: 'Hung Loi - Ninh Kieu -Can Tho', 
            txtPhone: '0944129603' 
        };
    }
...
const styles = StyleSheet.create({
    ...
    header: { flex: 1, backgroundColor: '#fff', alignItems: 'center', justifyContent: 'space-between', flexDirection: 'row', paddingHorizontal: 10 },// eslint-disable-line
